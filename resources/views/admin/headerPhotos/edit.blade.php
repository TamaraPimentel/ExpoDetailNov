...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.headerPhoto.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.header-photos.update", [$headerPhoto->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
