...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.videoFaq.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.video-faqs.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="video_faqs">{{ trans('cruds.videoFaq.fields.video_faqs') }}</label>
                <input class="form-control {{ $errors->has('video_faqs') ? 'is-invalid' : '' }}" type="text" name="video_faqs" id="video_faqs" value="{{ old('video_faqs', '') }}">
