...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Marca">
                <thead>
                    <tr>
                        <th width="10">
...
@can('marca_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.marcas.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-Marca:not(.ajaxTable)').DataTable({ buttons: dtButtons })
