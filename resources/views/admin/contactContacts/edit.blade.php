    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contact-contacts.update", [$contactContact->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook_url') ? 'is-invalid' : '' }}" type="text" name="facebook_url" id="facebook_url" value="{{ old('facebook_url', $contactContact->facebook_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instragram_url') ? 'is-invalid' : '' }}" type="text" name="instragram_url" id="instragram_url" value="{{ old('instragram_url', $contactContact->instragram_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('youtube_url') ? 'is-invalid' : '' }}" type="text" name="youtube_url" id="youtube_url" value="{{ old('youtube_url', $contactContact->youtube_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tiktok_url') ? 'is-invalid' : '' }}" type="text" name="tiktok_url" id="tiktok_url" value="{{ old('tiktok_url', $contactContact->tiktok_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twitter_url') ? 'is-invalid' : '' }}" type="text" name="twitter_url" id="twitter_url" value="{{ old('twitter_url', $contactContact->twitter_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_url') ? 'is-invalid' : '' }}" type="text" name="other_url" id="other_url" value="{{ old('other_url', $contactContact->other_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('button_text') ? 'is-invalid' : '' }}" type="text" name="button_text" id="button_text" value="{{ old('button_text', $contactContact->button_text) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('button_url') ? 'is-invalid' : '' }}" type="text" name="button_url" id="button_url" value="{{ old('button_url', $contactContact->button_url) }}" required>
